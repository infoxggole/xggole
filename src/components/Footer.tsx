      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-center md:justify-start gap-5 pt-4">
            {/* Facebook */}
            <a href="https://www.facebook.com/mirajul.hossain.75/" target="_blank" className="text-gray-400 hover:text-blue-500 transition-colors duration-300">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/mirajul_hossain.11/" target="_blank" className="text-gray-400 hover:text-pink-500 transition-colors duration-300">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* YouTube */}
            <a href="https://www.youtube.com/@MIRAJ1" target="_blank" className="text-gray-400 hover:text-red-500 transition-colors duration-300">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 text-gray-400 text-sm">
            <div className="flex items-center justify-center md:justify-start gap-3">
              ...
              <span>xggole.info@gmail.com</span>
            </div>
            <div className="flex items-center justify-center md:justify-start gap-3">
