    ...
    <footer className="bg-zinc-950 border-t border-zinc-900 pt-16 pb-8">
      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-center md:text-left">
        ...
        <div className="space-y-4 lg:col-span-2 lg:pr-12">
          <h3 className="text-3xl font-bold tracking-wider text-white">FGGOLE</h3>
          <p className="text-base font-medium text-cyan-400">
            AI-Powered Web & Mobile App Development
          </p>
          <p className="text-sm text-gray-400 leading-relaxed">
            Empower your business with intelligent digital solutions. At FGGOLE, we combine advanced AI technology with premium Web/App development and complete Corporate Identity Suites to build the future of your brand.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col items-center md:items-start space-y-3 pt-1">
            {/* Facebook */}
            <a href="https://www.facebook.com/mirajul.hossain.75/" target="_blank" className="flex items-center gap-3 text-gray-400 hover:text-blue-500 transition-colors duration-300">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/mirajul_hossain.11/" target="_blank" className="flex items-center gap-3 text-gray-400 hover:text-pink-500 transition-colors duration-300">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* YouTube */}
            <a href="https://www.youtube.com/@MIRAJ1" target="_blank" className="flex items-center gap-3 text-gray-400 hover:text-red-500 transition-colors duration-300">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path fillRule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s-.002 3.255-.42 4.814a2.504 2.504 0 0 1-1.768 1.768c-1.56.419-7.812.419-7.812.419s-6.252 0-7.812-.419a2.505 2.505 0 0 1-1.768-1.768C2 15.255 2 12 2 12s.002-3.255.42-4.814a2.507 2.507 0 0 1 1.768-1.768C5.748 5 12 5 12 5s6.252 0 7.812.418ZM10 15.5l6-3.5-6-3.5v7z" clipRule="evenodd" />
              </svg>
